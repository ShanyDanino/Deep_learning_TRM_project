...
try:
    from ..src.tiny_recursive_models.training.optimizers import AdamATan2
except Exception:
    AdamATan2 = None

from ..src.tiny_recursive_models.data import PuzzleDataset, PuzzleDatasetConfig, PuzzleDatasetMetadata
from ..src.tiny_recursive_models.data.utils import load_model_class, get_model_source_path
from ..src.tiny_recursive_models.data.models.sparse_embedding import CastedSparseEmbeddingSignSGD_Distributed
from ..src.tiny_recursive_models.data.models.ema import EMAHelper
from ..src.tiny_recursive_models.data.training import (
...
from .evaluation import evaluate, create_evaluators
